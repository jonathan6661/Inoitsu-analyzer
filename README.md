...
Inoitsu analyzer can helps when investigating suspicious mails received either from known/unknown senders. (Helps you ensure that the sender's email address is not compromised)
